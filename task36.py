...
# единицы (подумайте, почему не с нуля). Примечание:
# бинарной операцией называется любая операция, у
# которой ровно два аргумента, как, например, у операции умножения.
# Ввод: Вывод:
# 12
